    ...
    return (
      <div className={ cx('chat') }>
        ...
        <div className={ cx('chat-toolbar') }>
          <span className="chat-toolbar-title">{ 'Vaga: desenvolvedor Front-end' }</span>
          <div className="chat-toolbar-actions">
            <Icon glyph="icon-close" width={ 15 } height={ 15 } />
            <Icon glyph="icon-minimize" width={ 15 } height={ 15 } />
            <Icon glyph="icon-restore" width={ 15 } height={ 15 } />
          </div>
        </div>
